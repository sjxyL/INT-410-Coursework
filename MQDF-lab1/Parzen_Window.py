...
def fourD_plot(p1, p2, p3, p4): # To check the general properties of the dataset in 4D (Additional task)
    ...
    img = ax.scatter(x, y, z, c=c, cmap=plt.cool()) # The 4D datasets will be shown in the 3D coordinate with color gradient
    fig.colorbar(img)
    # Add axis
...
class Data_process: # Class for data pre-processing
    def __init__(self):
        self.filename = "../../Downloads/iris.data"  # Dataset folder name
